...
def main():
    ...
    parser.add_argument("--archive", required=True,
                        help="The path to the zip file containing "
                        "the dataset files.\n"
                        "Please download DVS Gesture dataset from "
                        "https://ibm.ent.box.com/s/"
                        "3hiq58ww1pbbjrinh367ykfdf60xsfm8/file/211521748942"
                        )
    ...
    if not check_integrity(
        fpath=args.archive, md5="8a5c71fb11e24e5ca5b11866ca6c00a1"
    ):
