...
| 3 | `tier3_invariants/` | metamorphic invariants: O0-O4 agreement, round isolation, `eject()` | GPU | ~1 s |
| 4 | `tier4_training/` | training mode: `run_train`, self-containment, persistent-fault semantics | GPU | ~2 s |
